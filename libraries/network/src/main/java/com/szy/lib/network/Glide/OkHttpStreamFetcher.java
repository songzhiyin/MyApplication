...
public class OkHttpStreamFetcher implements DataFetcher {
    ...
    public InputStream loadData(Priority priority) throws Exception {
        Request.Builder requestBuilder = new Request.Builder()
                .url(url.toStringUrl());
        for (Map.Entry essay_headerEntry : url.getHeaders().entrySet()) {
            String key = (String) essay_headerEntry.getKey();
            requestBuilder.addHeader(key, (String) essay_headerEntry.getValue());
        }
