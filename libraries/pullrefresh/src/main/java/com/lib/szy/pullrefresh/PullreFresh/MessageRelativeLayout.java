...
public class MessageRelativeLayout extends RelativeLayout {
    ...
    public void showMessage() {
        mScroller.startScroll(0, getHeaderMessageViewHeight(), 0, 0, PullRecyclerView.SCROLL_DURATION);
        invalidate();
    }

    public void hideMessage() {
        mScroller.startScroll(0, getVisibleHeight(), 0, -getVisibleHeight(), PullRecyclerView.SCROLL_DURATION);
        invalidate();
    }
